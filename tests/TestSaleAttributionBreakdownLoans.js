...
module.exports = {
  ...
  async runCustomTest() {
    ...
    const expensesAttr = (row33.attributions && row33.attributions.expenses) ? row33.attributions.expenses : {};
    const capitalAttr = (row33.attributions && row33.attributions.realestatecapital) ? row33.attributions.realestatecapital : {};
    ...
    const mortgageSettlement = expensesAttr['Mortgage Settlement (home)'] || 0;
    const reverseSettlement = expensesAttr['Reverse Mortgage Settlement (home)'] || 0;
    const saleNet = capitalAttr['Sale (home)'] || 0;
    const reverseWriteoff = capitalAttr['Reverse Mortgage Write-off (home)'] || 0;
