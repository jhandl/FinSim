  ...
  async runCustomTest() {
    ...
    const scenarioDefinition = {
      ...
      scenario: {
        ...
        events: [
          { type: 'R', id: 'prop-ss', amount: 300000, fromAge: 31, toAge: 60, currency: 'SSS', linkedCountry: 'ss' },
          { type: 'M', id: 'mort-ss', amount: 20000, fromAge: 31, toAge: 60, currency: 'SSS', linkedCountry: 'ss' },
    ...
    if (!withinTolerance(row34.expenses, expectedMortgagePre)) {
    ...
    if (!withinTolerance(row36.expenses, expectedMortgagePost)) {
      return { success: false, errors: ['Post-relocation mortgage conversion mismatch'] };
    }
