  ...
  async runCustomTest() {
    ...
    // Per-country mix config: assets use per-country settings
    {
      const params = {
        ...
        investmentGrowthRatesByKey: { indexFunds_ie: 0, indexFunds_ar: 0, shares_ie: 0, shares_ar: 0 },
        investmentVolatilitiesByKey: { indexFunds_ie: 0, indexFunds_ar: 0, shares_ie: 0, shares_ar: 0 },
        GlobalAssetGrowth_globalEquity: 0.1,
        GlobalAssetGrowth_globalBonds: 0,
        GlobalAssetVolatility_globalEquity: 0,
        GlobalAssetVolatility_globalBonds: 0,
    ...
    // Legacy fallback: no mix config uses per-asset growth rate
    {
      const params = {
        ...
        priorityShares: 3,
        investmentAllocationsByCountry: { ie: { indexFunds_ie: 1, shares_ie: 0 } },
        investmentGrowthRatesByKey: { indexFunds_ie: 0.07, shares_ie: 0 },
        investmentVolatilitiesByKey: { indexFunds_ie: 0, shares_ie: 0 }
      };
